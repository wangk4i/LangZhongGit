<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="C0041">
        <ClinicalDocument xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns ="urn:hl7-org:v3">
            ...
            <!-- 签名 -->
            <xsl:for-each select="HandoverPerson/RelatedPerson">
                <authenticator>
                    <!--交班日期时间-->
                    <time value="">
                        <xsl:attribute name="value">
            ...
            <xsl:for-each select="Successor/RelatedPerson">
                <authenticator>
                    <!--接班日期时间-->
                    <time value="">
                        <xsl:attribute name="value">
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="">
                                        ...
                                        <xsl:attribute name="displayName">
                                            <xsl:value-of select="EncounterTCMDiagName"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表（ GB/T 15657）" displayName="">
                                        ...
                                        <xsl:attribute name="displayName">
                                            <xsl:value-of select="EncounterTCMSyndromeName"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
                        ...
                        <section>
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" displayName="" codeSystem="2.16.156.10011.2.3.3.11" codeSystemName="诊断代码表ICD-10">
                                        <xsl:attribute name="code">
                                            <xsl:value-of select="PresentWMDiagCode"/>
                                        </xsl:attribute>
                                        <xsl:attribute name="displayName">
                                            <xsl:value-of select="PresentWMDiagName"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="">
                                        ...
                                        <xsl:attribute name="displayName">
                                            <xsl:value-of select="PresentTCMDiagName"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="">
                                        ...
                                        <xsl:attribute name="displayName">
                                            <xsl:value-of select="PresentTCMSyndromeName"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
