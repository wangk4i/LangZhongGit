<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="C0050">
        <ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            ...
            <xsl:for-each select="ResidentDoctor/row">
                <authenticator>
                    <time value="">
                        <xsl:attribute name="value">
                ...
                <structuredBody>
                    ...
                    <component>
                        <section>
                            ...
                            <xsl:for-each select="AdmDiagCode/AdmDiagCodeItem">
                                <entry>
                                    <observation classCode="OBS" moodCode="EVN">
                                        <code code="DE05.01.024.00" codeSystem="2.16.156.10011.2.2.1" codeSystemName="卫生信息数据元目录" displayName="入院诊断编码"/>
                                        <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.11.3" codeSystemName="诊断编码表ICD-10">
                                            <xsl:attribute name="code">
                                                <xsl:value-of select="."/>
                                            </xsl:attribute>
                                        </value>
                                ...
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <entryRelationship typeCode="COMP">
                                        <observation classCode="OBS" moodCode="EVN">
                                            ...
                                            <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.11.2" codeSystemName="死亡代码表ICD-10">
                                                <xsl:attribute name="code">
                                    ...
                                    <observation classCode="OBS" moodCode="EVN">
                                        ...
                                        <entryRelationship typeCode="CAUS">
                                            <observation classCode="OBS" moodCode="EVN">
                                                ...
                                                <value xsi:type="CD" code="" codeSystem="2.16.156.10011.2.3.3.11" codeSystemName="诊断编码表ICD-10">
                                                    <xsl:attribute name="code">
                            ...
                            <entry>
                                <observation classCode="OBS" moodCode="EVN">
                                    ...
                                    <value xsi:type="BL" value="">
                                        <xsl:attribute name="value">
                                            <xsl:value-of select="AutopsyConsentSign"/>
                                        </xsl:attribute>
                                    </value>
                                </observation>
                            </entry>
