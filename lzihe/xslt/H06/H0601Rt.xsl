<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="H0601Rt">
        <RCMR_IN000002UV02 ITSVersion="XML_1.0"
            xmlns="urn:hl7-org:v3"
            xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../multicacheschemas/RCMR_IN000002UV02.xsd">
            <!--id-消息流水号-->
            ...
            <controlActProcess classCode="STC" moodCode="APT">
                <subject typeCode="SUBJ">
                    <clinicalDocument classCode="DOCCLIN" moodCode="EVN">
                        ...
                        <!--文档保密级别-->
                        <confidentialityCode code="" codeSystem="2.16.156.10011.2.5.1.25" codeSystemName="文档保密级别代码">
                            <xsl:attribute name="code">
