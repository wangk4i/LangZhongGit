<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="H0703Rp">
        <PRPA_IN201306UV02 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 ../multicacheschemas/PRPA_IN201306UV02.xsd">
            <!--id-消息流水号-->
            ...
            <controlActProcess classCode="CACT" moodCode="EVN">
                <!--subject为0..* -->
                <xsl:for-each select="Subject/H0703RpSubject">
                        ...
                        <registrationEvent classCode="REG" moodCode="EVN">
                            ...
                            <subject1 typeCode="SBJ">
                                <patient classCode="PAT">
                                    <id>
                                        <!--就诊卡标识-->
                                        <item root="2.16.156.10011.2.5.1.6" extension="">
                                            <xsl:attribute name="extension"><xsl:value-of select="EncounterCardID"/></xsl:attribute>
                                        </item>
                                    </id>
                                    <!--就诊卡状态：active-激活；作废-diable；退卡-retired-->
                                    <statusCode code="">
                                        <xsl:attribute name="code"><xsl:value-of select="EncounterCardStatus"/></xsl:attribute>
                                    </statusCode>
                                    <!--建卡日期时间-->
                                    <effectiveTime>
                                        <low value="">
                            ...
                            <custodian typeCode="CST">
                                <assignedEntity classCode="ASSIGNED">
                                    <id>
                                        <item root="2.16.156.10011.1.5" extension="">
                                            <xsl:attribute name="extension"><xsl:value-of select="AssignedOrganCode"/></xsl:attribute>
                                        </item>
                                    </id>
                                    <assignedOrganization classCode="ORG" determinerCode="INSTANCE">
                                        <name xsi:type="DSET_EN">
                                            <item>
                                                <part value="">
                                                    <xsl:attribute name="value"><xsl:value-of select="AssignedOrganName"/></xsl:attribute>
                                                </part>
                                            </item>
                                        </name>
                ...
                <queryAck>
                    ...
                    <queryResponseCode code="">
                        <xsl:attribute name="code"><xsl:value-of select="QueryResponseCode"/></xsl:attribute>
                    </queryResponseCode>
