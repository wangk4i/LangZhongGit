            ...
            <controlActProcess classCode="ACTN" moodCode="EVN">
                <queryByParameter>
                    ...
                    <encounterTimeframe>
                        <value>
                            <low value="">
                                <xsl:attribute name="value"><xsl:value-of select="InPatientStartTime"/></xsl:attribute>
                            </low>
                            <high value="">
                                <xsl:attribute name="value"><xsl:value-of select="InPatientEndTime"/></xsl:attribute>
                            </high>
                        </value>
                    </encounterTimeframe>
                    <patientId>
