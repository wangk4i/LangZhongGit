<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <xsl:template match="H0710Rt">
        <PRPA_IN302011UV ITSVersion="XML_1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:v3="urn:hl7-org:v3" xmlns="urn:hl7-org:v3" xsi:schemaLocation="urn:hl7-org:v3 ../multicacheschemas/PRPA_IN302011UV.xsd">
            <!--id-消息流水号-->
            ...
            <interactionId root="2.16.156.10011.2.5.1.2" extension="PRPA_IN302011UV"/>
                    ...
                    <encounterEvent classCode="ENC" moodCode="EVN">
                        ...
                        <location1 typeCode="DST">
                            ...
                            <time xsi:type="IVL_TS" >
                                <low value="">
                                    <xsl:attribute name="value"><xsl:value-of select="TransInTime"/></xsl:attribute>
                                </low>
                            </time>
                            <statusCode/>
