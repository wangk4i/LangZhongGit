            ...
            <controlActProcess classCode="ACTN" moodCode="EVN">
                <queryByParameter>
                    ...
                    <encounterTimeframe>
                        <value>
                            <low value="">
                                <xsl:attribute name="value"><xsl:value-of select="DischargeStartTime"/></xsl:attribute>
                            </low>
                            <high value="">
                                <xsl:attribute name="value"><xsl:value-of select="DischargeEndTime"/></xsl:attribute>
                            </high>
                        </value>
                    </encounterTimeframe>
                    <!--患者标识 -->
