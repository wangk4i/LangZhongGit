            ...
            <xsl:choose>
                <xsl:when test="ResultCode = 'AA'">
                    <controlActProcess classCode="CACT" moodCode="EVN">
                        ...
                        <xsl:for-each select="Subject/CheckAppInfoItem">
                            <subject typeCode="SUBJ">
                                <observationRequest classCode="OBS" moodCode="RQO">
                                    ...
                                    <effectiveTime xsi:type="IVL_TS">
                                        <low value="">
                                            <xsl:attribute name="value">
                                                <xsl:value-of select="AppInfoEffectiveTimeLow"/>
                                            </xsl:attribute>
                                        </low>
                                        <high value="">
                                            <xsl:attribute name="value">
                                                <xsl:value-of select="AppInfoEffectiveTimeHigh"/>
                                            </xsl:attribute>
                                        </high>
                                    </effectiveTime>
                                    <!--优先（紧急）度-->
                                        ...
                                        <encounter classCode="ENC" moodCode="EVN">
                                            <id>
                                                ...
                                                <item extension="" root="2.16.156.10011.2.5.1.8">
                                                    <xsl:attribute name="value">
                                                        <xsl:value-of select="SeenTimes"/>
                                                    </xsl:attribute>
                                                </item>
                                                <!-- 就诊流水号 -->
                                                <item extension="" root="2.16.156.10011.2.5.1.9">
                                                    <xsl:attribute name="value">
                                                        <xsl:value-of select="SeenSerialNumber"/>
                                                    </xsl:attribute>
                                                </item>
                                            </id>
                                            <!--就诊类别编码-->
                                            <code codeSystem="2.16.156.10011.2.3.1.271" codeSystemName="患者类型代码表" code="">
                                                <xsl:attribute name="code">
                                                    <xsl:value-of select="SeenTypeCode"/>
                                                </xsl:attribute>
                                                <!-- 就诊类别名称 -->
                                                <displayName value="">
                                                    <xsl:attribute name="value">
                                                        <xsl:value-of select="SeenTypeName"/>
                                                    </xsl:attribute>
                                                </displayName>
                                            </code>
                                            <!--必须项未使用 -->
                                            ...
                                            <subject typeCode="SBJ">
                                                <patient classCode="PAT">
                                                    ...
                                                    <patientPerson classCode="PSN">
                                                        ...
                                                        <birthTime value="">
                                                            <xsl:attribute name="value">
                                                                <xsl:value-of select="PatientBirthTime"/>
                                                            </xsl:attribute>
                                                            <!--年龄 -->
                                                            <originalText value="">
                                                                <xsl:attribute name="value">
